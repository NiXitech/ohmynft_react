        ...
        <div className="w-full mx-auto max-w-5xl 5xl:container">
          <div className="prose prose-invert w-full max-w-none textPage" >
            <div>
              ...
              <h2 id='30-types-of-cookies'>3.0 Types of Cookies</h2>
              <p>The following types of cookies may be used when you visit the Site:</p>
              <h4 id='advertising-cookies'>Advertising Cookies</h4>
              ...
              <h4 id='analytic-cookies'>Analytic Cookies</h4>
              <p>Analytic cookies monitor how users reached the Site, and how they interact with and move around once on the Site. These cookies let us know what features on the Site are working the best and what features on the Site can be improved.</p>
              <h4 id='our-cookies'>Our Cookies</h4>
              ...
              <h4 id='personalization-cookies'>Personalization Cookies</h4>
              ...
              <h4 id='security-cookies'>Security Cookies</h4>
              ...
              <h4 id='site-management-cookies'>Site Management Cookies</h4>
              ...
              <h2 id='40-control-of-cookies'>4.0 Control of Cookies</h2>
              ...
              <ul>
                ...
                <li>Microsoft Internet Explorer Mozilla Firefox</li>
                <li>Opera</li>
              ...
              <h2 id='50-other-tracking-technologies'>5.0 Other Tracking Technologies</h2>
              <p>In addition to cookies, we may use web beacons, pixel tags, and other tracking technologies on the Site to help customize the Site and improve your experience. A “web beacon” or “pixel tag” is a tiny object or image embedded in a web page or email. They are used to track the number of users who have visited particular pages and viewed emails, and acquire other statistical data. They collect only a limited set of data, such as a cookie number, the time and date of a page or email view, and a description of the page or email on which they reside. Web beacons and pixel tags cannot be declined. However, you can limit their use by controlling the cookies that interact with them.</p>
