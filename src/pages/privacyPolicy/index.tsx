        ...
        <div className="w-full mx-auto max-w-5xl 5xl:container">
          <div className="prose prose-invert w-full max-w-none textPage" >
            <div>
              ...
              <p>This Privacy Notice explains how ohmynft.space uses your personal information when you’re using our website.</p>
              <p>If you do not agree with any statements contained within this Privacy Notice, please do not proceed any further on our website. Please be aware that registering an account on our website will be deemed confirmation of your full agreement with our Terms &amp; Conditions and our Privacy Policy. You have the right to cease using the website at any time; however, we may still be legally required to retain some of your personal information.</p>
              ...
              <h2 id='20-who-is-in-control-of-your-information'>2.0 Who is in control of your information?</h2>
              <p>Throughout this Privacy policy, &quot;ohmynft&quot;, &quot;we&quot;, &quot;our&quot; and &quot;us&quot; relates to Pow Lab Ltd, having its registered address at Trust Company Complex, Ajeltake Road, Ajeltake Island, Majuro, Republic of the Marshall Island MH 96960. We are the Data Controller. A ‘Controller’ is a person or company who determines how and why your personal information is used. If you have any concerns or would like further information about how ohmynft handles your personal information, you can contact us at feedback@ohmynft.space</p>
              <h2 id='30-information-we-collect-about-you'>3.0 Information we collect about you</h2>
              <h4 id='personally-identifiable-information'>Personally identifiable information</h4>
              <p>You provide this information to us in the process of setting up an account, participating in games, and using the services of the website. This information is required to give you access to certain parts of our website and related services. This data is collected when you:</p>
              <ul>
                <li>Register an account with ohmynft</li>
              ...
              <ul>
                ...
                <li>Any other information you provide us when using our platform</li>
                <li>Credit/debit card details, or other payment information</li>

              </ul>

              <p>The information is also required for billing and payments purposes and for the protection of minors. You can amend and update this information by contacting feedback@ohmynft.space. This data is for internal use only and is never passed to any third parties except those stated below.</p>
              <h4 id='non-personally-identifiable-information-and-traffic-analysis'>Non-personally identifiable information and traffic analysis</h4>
              <p>ohmynft strives to make our website as user friendly as possible and easy to find on the internet. ohmynft collects data on how you use the site, which does not identify you personally. When you interact with the services, our servers keep an activity log unique to you that collects certain administrative and traffic information including: source IP address, time of access, date of access, web page(s) visited, language use, software crash reports and type of browser used. This information is essential for the provision and quality of our services.</p>
              <h4 id='cookies'>Cookies</h4>
              <p>ohmynft uses cookies to ensure our website works efficiently and to enhance your visits to our platform. Further information can be found in our Cookie Policy.</p>
              <h2 id='40-how-and-why-we-use-your-personal-information'>4.0 How and why we use your personal information</h2>
              ...
              <p>Your rights over your personal information differ according to which category and lawful basis these fall into. These sections provide more information about each category, the rights it gives you, and how to exercise these rights. These rights are in bold following each category.</p>
              <h4 id='providing-our-products-and-services'>Providing our products and services</h4>
              <p>We use your personal information to enable you to use our websites, to set up your account, participate in the online games and to provide you with customer service assistance.</p>
              <p>To provide our products and services, we share your information with external organisations working on our behalf. This category covers the essential activities required in order for us to provide you with the services you use or have signed up for. If you don’t want your information used in this way, your option is to not use our services and close your account.</p>
              <h4 id='legal-and-regulatory-requirements'>Legal and Regulatory Requirements</h4>
              <p>ohmynft are legally bound; to comply with these requirements, we carry out identity verification, fraud prevention and anti-money laundering checks when you create an account and/or withdraw a prize pay out.</p>
              <p>ohmynft will use your identification document and/or proof of address to check your details in order for us to protect our users from fraudulent behaviour and comply with relevant Anti Money Laundering legislation.</p>
              ...
              <p>We are required to carry out these activities to provide our products and services legally, responsibly, and in line with the requirements stipulated. We cannot provide you with our services without carrying out these activities, if you don’t want your information used in this way, your option is to not use our services and close your account.</p>
              <h4 id='to-monitor-our-website-performance'>To monitor our website performance</h4>
              ...
              <h2 id='50-your-rights'>5.0 Your Rights</h2>
              <p>Your rights to rectification</p>
              <p>If you believe the personal information we hold on you is incorrect, you have the right for this to be rectified. For any information that cannot be updated through your account online, please contact feedback@ohmynft.space</p>
              <h4 id='your-right-to-request-a-copy-of-your-personal-information'>Your right to request a copy of your personal information</h4>
              <p>If you would like a copy of the personal information we hold about you, you should request it through emailing feedback@ohmynft.space and we will provide you with a form to complete. The form is not compulsory but helps us to provide you with the information you are looking for in a timely manner.</p>
              ...
              <h4 id='your-right-to-complain-to-the-regulator'>Your right to complain to the regulator</h4>
              <p>your privacy rights, you have the right to complain to the Data Protection Commission by visiting this site: <a href='https://www.gra.gi/data-protection/complaints' target='_blank' rel="noreferrer">https://www.gra.gi/data-protection/complaints</a></p>
              <h2 id='60-sharing-your-personal-information'>6.0 Sharing your personal information</h2>
              ...
              <h2 id='100-disclaimer'>10.0 Disclaimer</h2>
