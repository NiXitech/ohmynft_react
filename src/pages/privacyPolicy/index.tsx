        ...
        <div className="w-full mx-auto max-w-5xl 5xl:container">
          <div className="prose prose-invert w-full max-w-none textPage" >
            <div>
              ...
              <p>This Privacy Notice explains how WinBig.space uses your personal information when you’re using our website.</p>
              ...
              <p>Throughout this Privacy policy, &quot;WinBig&quot;, &quot;we&quot;, &quot;our&quot; and &quot;us&quot; relates to Pow Lab Ltd, having its registered address at Trust Company Complex, Ajeltake Road, Ajeltake Island, Majuro, Republic of the Marshall Island MH 96960. We are the Data Controller. A ‘Controller’ is a person or company who determines how and why your personal information is used. If you have any concerns or would like further information about how WinBig handles your personal information, you can contact us at feedback@winbig.space</p>
              ...
              <ul>
                <li>Register an account with WinBig</li>
              ...
              <p>The information is also required for billing and payments purposes and for the protection of minors. You can amend and update this information by contacting feedback@winbig.space. This data is for internal use only and is never passed to any third parties except those stated below.</p>
              ...
              <p>WinBig strives to make our website as user friendly as possible and easy to find on the internet. WinBig collects data on how you use the site, which does not identify you personally. When you interact with the services, our servers keep an activity log unique to you that collects certain administrative and traffic information including: source IP address, time of access, date of access, web page(s) visited, language use, software crash reports and type of browser used. This information is essential for the provision and quality of our services.</p>
              <h4 id='cookies'>Cookies</h4>
              <p>WinBig uses cookies to ensure our website works efficiently and to enhance your visits to our platform. Further information can be found in our Cookie Policy.</p>
              ...
              <p>WinBig are legally bound; to comply with these requirements, we carry out identity verification, fraud prevention and anti-money laundering checks when you create an account and/or withdraw a prize pay out.</p>
              <p>WinBig will use your identification document and/or proof of address to check your details in order for us to protect our users from fraudulent behaviour and comply with relevant Anti Money Laundering legislation.</p>
              ...
              <p>If you believe the personal information we hold on you is incorrect, you have the right for this to be rectified. For any information that cannot be updated through your account online, please contact feedback@winbig.space</p>
              ...
              <p>If you would like a copy of the personal information we hold about you, you should request it through emailing feedback@winbig.space and we will provide you with a form to complete. The form is not compulsory but helps us to provide you with the information you are looking for in a timely manner.</p>
